#!/usr/bin/env python3
"""
Standalone micro-synteny figure - ECD04 A08 locus vs IH1-IH5, target BraA08t039305E.

Draws: ECD04 A08 region full-width in the middle; IH1/IH2 side-by-side on top;
...
RUN:    python microsynteny_A08.py
OUTPUT: microsynteny_A08.png / .pdf
"""
...
CHROM, START, END = "A08", 14935176, 15537537
TARGET  = "BraA08t039305E"
...
WINDOWS = {
    "IH1": ("contig_1575_polished", 6174,   564764),
    "IH2": ("contig_1114_polished", 0,      None),     # whole contig
    "IH3": ("contig_3767_polished", 2000,   312065),
    "IH4": ("contig_1467_polished", 120947, 293552),   # display 62.992-235.597 K reversed
    "IH5": ("contig_3607_polished", 7789,   101010),
}
